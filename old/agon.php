	...
	<body onload="canvasInit(); lightbox.init();">
		<div id="page">
			...
			<div id="content">
				...
				<div id="info" class="agon">

					<div id="stat">
						<?php $stat = "ra"; ?>
						<div id="<?php echo($stat); ?>">
							<?php for ($i = 1; $i < 7; $i++) { ?>
								<label onclick="checklv('<?php echo($stat); ?>', this);">
									<input class="print sys" type="checkbox" name="<?php echo($stat); ?>[]" value="<?php echo($i); ?>">
									<span></span>
								</label>
							<?php } ?>
						</div>
